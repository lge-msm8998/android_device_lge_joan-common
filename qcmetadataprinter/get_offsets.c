...
int main() {
    ...
    PRINT(CAM_INTF_LGE_RESERVED_3,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_4,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_5,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_6,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_7,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_2,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_1,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_8,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_9,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_10,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_11,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_25,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_26,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_27,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_29,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_12,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_13,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_14,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_15,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_16,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_17,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_18,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_19,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_20,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_21,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_22,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_23,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_24,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_28,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_30,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_31,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_32,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_33,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_34,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_35,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_36,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_37,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_38,    pMetadata);
    PRINT(CAM_INTF_LGE_RESERVED_39,    pMetadata);
